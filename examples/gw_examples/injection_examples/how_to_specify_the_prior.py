...
# There are many other prior classes defined, see the documentation for details.
# It's also possible to load an interpolate a prior from a file or define your
# own prior class.
