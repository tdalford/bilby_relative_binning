...
Extra requirements
==================
- nestle: a pure-python nested sampling package, available from pip
...
priors["chirp_mass"] = bilby.core.prior.TruncatedGaussian(
    mu=1.215, sigma=0.01, minimum=1, maximum=2, name="chirp_mass", unit="$M_{\\odot}$"
)
priors["symmetric_mass_ratio"] = bilby.core.prior.Uniform(
    minimum=0.1, maximum=0.25, name="symmetric_mass_ratio"
)
priors["lambda_tilde"] = bilby.core.prior.Uniform(
    minimum=0, maximum=5000, name="lambda_tilde"
)
priors["delta_lambda"] = bilby.core.prior.Uniform(
    minimum=-5000, maximum=5000, name="delta_lambda"
)
priors["mass_1"] = bilby.core.prior.Constraint(minimum=1, maximum=2)
priors["mass_2"] = bilby.core.prior.Constraint(minimum=1, maximum=2)
