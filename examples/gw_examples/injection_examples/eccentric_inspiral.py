...
"fast_tutorial.py" example.

Extra requirements
==================
- pymultinest: a python wrapper to MultiNest, a nested sampling package
...
priors["mass_1"] = bilby.core.prior.Uniform(
    name="mass_1", minimum=25, maximum=45, unit="$M_{\\odot}$"
)
priors["mass_2"] = bilby.core.prior.Uniform(
    name="mass_2", minimum=25, maximum=45, unit="$M_{\\odot}$"
)
...
priors["luminosity_distance"] = bilby.gw.prior.UniformComovingVolume(
    name="luminosity_distance", minimum=1e1, maximum=1e3
)
