...
priors["chirp_mass"] = bilby.prior.Uniform(
    minimum=13, maximum=45, name="chirp_mass", latex_label="$m_c$", unit="$M_{\\odot}$"
)
...
# We use dynesty as our sampler and reduce `nlive`, `walks` and `nact` from
# the default values to speed up sampling in this simple case.
