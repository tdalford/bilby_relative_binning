...
We use the cubic spline model commonly used in LVK data analysis.
...
# with the uniform (unif) sampling method. This can be more efficient than
# random walk (rwalk) for simple small dimensional cases, such as this
