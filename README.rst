...
``/examples/gw_examples/data_examples/relative_binning_tests.ipynb`` (file added to test functionality of this new class and to aid in debugging.)

How to run:

A sample test is set up in the
``/examples/gw_examples/data_examples/relative_binning_tests.ipynb`` as mentioned.
